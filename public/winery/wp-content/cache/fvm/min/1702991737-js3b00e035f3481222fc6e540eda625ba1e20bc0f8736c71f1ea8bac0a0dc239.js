...
try {
    jQuery(window).on("elementor/frontend/init", (function() {
        elementorFrontend.hooks.addAction("frontend/element_ready/the7-elements-woo-simple-products-carousel.default", (function(e, n) {
            window.the7ProcessEffects(e.find(".wf-cell:not(.shown)"))
        }))
    }))
} catch (e) {
    console.error("An error has occurred. [ File: https://the7.io/winery/wp-content/themes/dt-the7/js/compatibility/elementor/woocommerce-simple-products-carousel.min.js?ver=11.10.1 ] [ " + e.stack + " ]");
}
try {
    jQuery((function(e) {
