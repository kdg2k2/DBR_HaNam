...
try {
    ! function(t) {
        function n(n) {
            t("body").on("wc_cart_button_updated", (function(t, e) {
                if (e.attr("data-widget-id") !== n.attr("data-id")) return;
                const o = n.find(".elementor-widget-container > .added-to-cart-icon-template").children().clone(),
                    a = e.next();
                e.hasClass("woo-popup-button") && (o.addClass("popup-icon"), a.wrapInner('<span class="filter-popup"></span>')), a.append(o)
            }))
        }

        function e(t) {
            var n = t.parent().hasClass("mode-masonry") ? t.parent() : t,
                e = "data-tablet-columns-num",
                o = "data-mobile-columns-num";
            n.hasClass("products-shortcode") && (e = "data-v-tablet-columns-num", o = "data-phone-columns-num");
            var a = t.width() - 1,
                r = elementorFrontend.config.breakpoints,
                d = 1;
            const i = new The7ElementorSettings(t.closest(".elementor-widget")).getSettings("widget_columns_wide_desktop_breakpoint");
            let s = dtLocal.elementor.settings.container_width + 1;
            if (i && (s = i + 1), s <= window.innerWidth) d = parseInt(n.attr("data-wide-desktop-columns-num"));
            else {
                var l = [{
                    breakpoint: r.xl,
                    columns: parseInt(n.attr("data-desktop-columns-num"))
                }, {
                    breakpoint: r.lg,
                    columns: parseInt(n.attr(e))
                }, {
                    breakpoint: r.md,
                    columns: parseInt(n.attr(o))
                }];
                l = l.sort(((t, n) => n.breakpoint - t.breakpoint)), d = l[0].columns, l.forEach((function(t) {
                    window.innerWidth < t.breakpoint && (d = t.columns)
                }))
            }
            return {
                singleWidth: Math.floor(a / d) + "px",
                doubleWidth: 2 * Math.floor(a / d) + "px",
                columnsNum: d
            }
        }
        t(window).on("elementor/frontend/init", (function() {
            elementorFrontend.hooks.addAction("frontend/element_ready/the7_elements.default", (function(t) {
                the7ApplyColumns(t.attr("data-id"), t.find(".iso-container"), e), the7ApplyMasonryWidgetCSSGridFiltering(t.find(".jquery-filter .dt-css-grid"))
            })), elementorFrontend.hooks.addAction("frontend/element_ready/the7-wc-products.default", (function(t) {
                the7ApplyColumns(t.attr("data-id"), t.find(".iso-container"), e), the7ApplyMasonryWidgetCSSGridFiltering(t.find(".jquery-filter .dt-css-grid")), n(t)
            })), elementorFrontend.hooks.addAction("frontend/element_ready/the7-wc-products-carousel.default", n)
        }))
    }(jQuery)
} catch (e) {
    console.error("An error has occurred. [ File: https://the7.io/winery/wp-content/themes/dt-the7/js/compatibility/elementor/the7-masonry-widget.min.js?ver=11.10.1 ] [ " + e.stack + " ]");
}
try {
    jQuery((function(e) {
